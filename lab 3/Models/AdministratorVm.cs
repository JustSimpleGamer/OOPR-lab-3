...
{
    public class AdministratorVm : IAdministrator //1. Class implementation
    {
        ...
        public void TrashFunc() //мусорна функція для реалізації 2.1 інтерфейсне посилання
        {
            MessageBox.Show("Реалізація завдання 2.1 інтерфейнса посилання", "Успіх", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
        }
    }
}
